...
| Current Channel                | Yes, see [supported versions](/officeupdates/update-history-microsoft365-apps-by-date#supported-versions). | Yes, see [supported versions](/officeupdates/update-history-microsoft365-apps-by-date#supported-versions). |
| Monthly Enterprise Channel                | Yes, see [supported versions](/officeupdates/update-history-microsoft365-apps-by-date#supported-versions).| Yes, see [supported versions](/officeupdates/update-history-microsoft365-apps-by-date#supported-versions). |
| Semi-Annual Enterprise Channel            | Yes, see [supported versions](/officeupdates/update-history-microsoft365-apps-by-date#supported-versions).| Yes, see [supported versions](/officeupdates/update-history-microsoft365-apps-by-date#supported-versions). |
