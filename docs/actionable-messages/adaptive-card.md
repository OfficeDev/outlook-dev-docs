...
> [!NOTE]
> Before you can use the `Action.Transaction` type, you must register in the [Payments in Outlook Partner Dashboard](../payments/partner-dashboard) to receive a merchant ID and display ID.
...
| `initializationContext.merchantId` | GUID | Yes | Your merchant ID obtained by registering in the [Payments in Outlook Partner Dashboard](../payments/partner-dashboard). |
| `initializationContext.displayId` | GUID | Yes | Your display ID obtained by registering in the [Payments in Outlook Partner Dashboard](../payments/partner-dashboard). |
