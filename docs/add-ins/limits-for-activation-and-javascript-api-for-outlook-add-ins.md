...
|Roaming settings|32 KB number of characters|[RoamingSettings](/javascript/api/outlook/office.RoamingSettings) object<br/><br/> [context.roamingSettings](/office/dev/add-ins/reference/objectmodel/requirement-set-1.5/Office.context#roamingsettings-roamingsettings) property|Limit for all roaming settings for the add-in. All the Outlook hosts return an error if your settings exceed this limit.|
