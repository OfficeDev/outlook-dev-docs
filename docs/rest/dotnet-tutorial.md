---
title: Write an ASP.NET MVC Web app to get Outlook mail | Microsoft Docs
...
Head over to the [Application Registration Portal](https://apps.dev.microsoft.com/) to quickly get a client ID and secret. 
