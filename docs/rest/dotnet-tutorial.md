...
Head over to the [Azure Active Directory admin center](https://aad.portal.azure.com) to quickly get an application ID and secret.

1. Determine your ASP.NET app's URL. In Visual Studio's Solution Explorer, select the project. In the **Properties** window, find the value of **URL**. Copy this value.
...
1. Select **New registration**. On the **Register an application** page, set the values as follows.
    ...
    - Set **Name** to `ASP.NET Outlook Tutorial`.
...
1. Choose **Register**. On the **ASP.NET Outlook Tutorial** page, copy the value of the **Application (client) ID** and save it, you will need it in the next step.
